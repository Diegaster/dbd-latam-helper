...
const killersData = {
  Nurse: { display: "The Nurse", spanish: "La Enfermera", aliases: ["Sally Smithson"], image: "https://deadbydaylight.wiki.gg/images/3/3b/K04_TheNurse_Portrait.png" },
  Blight: { display: "The Blight", spanish: "El Deterioro", aliases: ["Talbot Grimes"], image: "https://deadbydaylight.wiki.gg/images/K21_TheBlight_Portrait.png" },
  Hillbilly: { display: "The Hillbilly", spanish: "El Pueblerino", aliases: ["Max Thompson Jr."], image: "https://deadbydaylight.wiki.gg/images/2/24/K03_TheHillbilly_Portrait.png" },
  Ghoul: { display: "The Ghoul", spanish: "El Ghoul", aliases: ["Ken Kaneki", "Rize Kamishiro"], image: "https://deadbydaylight.wiki.gg/images/K39_TheGhoul_Portrait.png" },
  Krasue: { display: "The Krasue", spanish: "La Krasue", aliases: ["Burong Sukapat"], image: "https://deadbydaylight.wiki.gg/images/K41_TheKrasue_Portrait.png" },
  Singularity: { display: "The Singularity", spanish: "La Singularidad", aliases: ["HUX-A7-13"], image: "https://deadbydaylight.wiki.gg/images/2/24/K32_TheSingularity_Portrait.png" },
  Spirit: { display: "The Spirit", spanish: "El Espíritu", aliases: ["Rin Yamaoka"], image: "https://deadbydaylight.wiki.gg/images/f/f1/K13_TheSpirit_Portrait.png" },
  Twins: { display: "The Twins", spanish: "Los Gemelos", aliases: ["Charlotte & Victor Deshayes"], image: "https://deadbydaylight.wiki.gg/images/1/17/K22_TheTwins_Portrait.png" },
  DarkLord: { display: "The Dark Lord", spanish: "El Señor Oscuro", aliases: ["Drácula"], image: "https://deadbydaylight.wiki.gg/images/K37_TheDarkLord_Portrait.png" },
  Oni: { display: "The Oni", spanish: "-", aliases: ["Kazan Yamoka"], image: "https://deadbydaylight.wiki.gg/images/8/80/K18_TheOni_Portrait.png" },
  Huntress: { display: "The Huntress", spanish: "La Cazadora", aliases: ["Anna"], image: "https://deadbydaylight.wiki.gg/images/f/f1/K08_TheHuntress_Portrait.png" },
  Artist: { display: "The Artist", spanish: "La Artista", aliases: ["Carmina Mora"], image: "https://deadbydaylight.wiki.gg/images/0/01/K26_TheArtist_Portrait.png" },
  Mastermind: { display: "The Mastermind", spanish: "La Mente Maestra", aliases: ["Albert Wesker"], image: "https://deadbydaylight.wiki.gg/images/e/ec/K29_TheMastermind_Portrait.png" },
  Cenobite: { display: "The Cenobite", spanish: "El Cenobita", aliases: ["Elliot Spencer"], image: "https://deadbydaylight.wiki.gg/images/K25_TheCenobite_Portrait.png" },
  Plague: { display: "The Plague", spanish: "La Plaga", aliases: ["Adiris"], image: "https://deadbydaylight.wiki.gg/images/f/fe/K15_ThePlague_Portrait.png" },
  Doctor: { display: "The Doctor", spanish: "El Doctor", aliases: ["Herman Carter"], image: "https://deadbydaylight.wiki.gg/images/5/58/K07_TheDoctor_Portrait.png" },
  Clown: { display: "The Clown", spanish: "El Payaso", aliases: ["Kenneth Chase", "Jeffrey Hawk"], image: "https://deadbydaylight.wiki.gg/images/d/d1/K12_TheClown_Portrait.png" },
  Nightmare: { display: "The Nightmare", spanish: "La Pesadilla", aliases: ["Freddy Krueger"], image: "https://deadbydaylight.wiki.gg/images/d/d5/K10_TheNightmare_Portrait.png" },
  Executioner: { display: "The Executioner", spanish: "El Ejecutor", aliases: ["Pyramid Head"], image: "https://deadbydaylight.wiki.gg/images/c/c9/K20_TheExecutioner_Portrait.png" },
  Xenomorph: { display: "The Xenomorph", spanish: "El Xenomorfo", aliases: [], image: "https://deadbydaylight.wiki.gg/images/6/64/K33_TheXenomorph_Portrait.png" },
  Unknown: { display: "The Unknown", spanish: "Lo Desconocido", aliases: [], image: "https://deadbydaylight.wiki.gg/images/5/51/K35_TheUnknown_Portrait.png" },
  GoodGuy: { display: "The Good Guy", spanish: "El Chico Bueno", aliases: ["Chucky", "Charles Lee Ray"], image: "https://deadbydaylight.wiki.gg/images/8/81/K34_TheGoodGuy_Portrait.png" },
  Lich: { display: "The Lich", spanish: "El Liche", aliases: ["Vecna"], image: "https://deadbydaylight.wiki.gg/images/K36_TheLich_Portrait.png" },
  ...
  Wraith: { display: "The Wraith", spanish: "El Espectro", aliases: ["Phillip Ojomo"], image: "https://deadbydaylight.wiki.gg/images/c/c2/K02_TheWraith_Portrait.png" },
  Deathslinger: { display: "The Deathslinger", spanish: "El Arponero de la Muerte", aliases: ["Caleb Quinn"], image: "https://deadbydaylight.wiki.gg/images/a/ac/K19_TheDeathslinger_Portrait.png" },
  Animatronic: { display: "The Animatronic", spanish: "El Animatrónico", aliases: ["Springtrap", "William Afton"], image: "https://deadbydaylight.wiki.gg/images/0/02/K40_TheAnimatronic_Portrait.png" },
  Demogorgon: { display: "The Demogorgon", spanish: "El Demogorgon", aliases: [], image: "https://deadbydaylight.wiki.gg/images/7/75/K17_TheDemogorgon_Portrait.png" },
  Dredge: { display: "The Dredge", spanish: "La Draga", aliases: [], image: "https://deadbydaylight.wiki.gg/images/7/7e/K28_TheDredge_Portrait.png" },
  Onryo: { display: "The Onryō", spanish: "La Onryō", aliases: ["Sadako Yamamura"], image: "https://deadbydaylight.wiki.gg/images/5/5f/K27_TheOnryo_Portrait.png" },
  Trickster: { display: "The Trickster", spanish: "El Embaucador", aliases: ["Ji-Woon Hak"], image: "https://deadbydaylight.wiki.gg/images/c/c9/K23_TheTrickster_Portrait.png" },
  Legion: { display: "The Legion", spanish: "La Legión", aliases: ["Frank", "Julie", "Susie", "Joey"], image: "https://deadbydaylight.wiki.gg/images/5/53/K14_TheLegion_Portrait.png" },
  Cannibal: { display: "The Cannibal", spanish: "El Caníbal", aliases: ["Leatherface", "Bubba Sawyer"], image: "https://deadbydaylight.wiki.gg/images/6/6f/K09_TheCannibal_Portrait.png" },
  Hag: { display: "The Hag", spanish: "La Bruja", aliases: ["Lisa Sherwood"], image: "https://deadbydaylight.wiki.gg/images/c/c7/K06_TheHag_Portrait.png" },
  Pig: { display: "The Pig", spanish: "La Cerda", aliases: ["Amanda Young"], image: "https://deadbydaylight.wiki.gg/images/5/5c/K11_ThePig_Portrait.png" },
  GhostFace: { display: "The Ghost Face", spanish: "Ghost Face", aliases: ["Danny Johnson"], image: "https://deadbydaylight.wiki.gg/images/d/d1/K16_TheGhostFace_Portrait.png" },
  Trapper: { display: "The Trapper", spanish: "El Trampero", aliases: ["Evan MacMillan"], image: "https://deadbydaylight.wiki.gg/images/8/81/K01_TheTrapper_Portrait.png" },
  ...
  Knight: { display: "The Knight", spanish: "El Caballero", aliases: ["Tarhos Kovács"], image: "https://deadbydaylight.wiki.gg/images/6/69/K30_TheKnight_Portrait.png"},
  SkullMerchant: { display: "The Skull Merchant", spanish: "La Comerciante de Calaveras", aliases: ["Adriana Imai"], image: "https://deadbydaylight.wiki.gg/images/6/64/K31_TheSkullMerchant_Portrait.png"},
